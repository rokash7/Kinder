...
namespace Kinder.MessageCore.Services
{
    public class ChatService : IChatService
    {
        ...
        private string url = "http://localhost:8080/signalchat"; //TODO: change port

        event Action<string, string, MessageType> IChatService.NewTextMessage
        {
            add
            {
        ...
        event Action<string, byte[], MessageType> IChatService.NewImageMessage
        {
            add
            {
                throw new NotImplementedException();
